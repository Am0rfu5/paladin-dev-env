...
<required_reading>
@/workspace/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/workspace/.claude/gsd-core/references/debugger-philosophy.md
...
@/workspace/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@/workspace/.claude/gsd-core/references/debugger-repro-hardening.md
...
@/workspace/.claude/gsd-core/references/debugger-semantic-recall.md
...
@/workspace/.claude/gsd-core/references/thinking-models-debug.md
...
@/workspace/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @/workspace/.claude/gsd-core/references/common-bug-patterns.md
...
@/workspace/.claude/gsd-core/references/debugger-rca-branching.md
...
@/workspace/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@/workspace/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@/workspace/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
