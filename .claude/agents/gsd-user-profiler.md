...
<reference>
@/workspace/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspace/.claude/gsd-core/references/user-profiling.md` to load:
