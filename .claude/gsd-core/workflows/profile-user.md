...
Key references:
- @/workspace/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/workspace/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspace/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspace/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/workspace/.claude/gsd-core/USER-PROFILE.md" "/workspace/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspace/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/workspace/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/workspace/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /workspace/.claude/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspace/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Your profile:    /workspace/.claude/gsd-core/USER-PROFILE.md
```
