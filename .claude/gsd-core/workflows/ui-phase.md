...
Template: /workspace/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
@/workspace/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspace/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspace/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspace/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
