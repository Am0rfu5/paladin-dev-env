...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/workspace/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/workspace/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/workspace/.claude/gsd-core/workflows/diagnose-issues.md
