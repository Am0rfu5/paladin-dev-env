...
fixed_count: 1
total_count: 21
last_updated: 2026-08-23T12:55:15.198Z
---
...
| 21 | 17 | blocker | crates/paladin-llm/src/qwen/adapter.rs |  | Plan 17-21 Task 2 was BLOCKED on an Alibaba Cloud Model Studio account entitlement (HTTP 403 Model.AccessDenied on every model) after Task 1 moved QWEN_DEFAULT_BASE_URL to the US (Virginia) endpoint, ruled out as a stale-identifier problem across 78 qwen-prefixed identifiers and both invocation endpoints. | resolved | Resolved 2026-08-23, externally: DASHSCOPE_API_KEY was replaced with a Singapore-scoped credential; against the corrected shipped default (dashscope-intl, Singapore), every measured request succeeded (162-model catalog, generate() PASS, all five sampling parameters and both temperature_range endpoints measured). No code change resolved this row; live_vendor_smoke now exits 0 with all four vendors PASSING both probes. See 17-21-SUMMARY.md's 2026-08-23 update. | 2026-08-22T18:05:00.000Z | 2026-08-23T12:55:15.198Z |
