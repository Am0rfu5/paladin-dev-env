    ...
    pub fn content_type_stats(&self) -> std::collections::HashMap<String, usize> {
        ...
        for item in &self.items {
            let content_type = match item.content() {
                crate::platform::container::content::ContentType::Text(_) => "Text",
                crate::platform::container::content::ContentType::Video(_) => "Video",
                crate::platform::container::content::ContentType::Audio(_) => "Audio",
                crate::platform::container::content::ContentType::Image(_) => "Image",
            };
...
mod tests {
    use super::*;
    use crate::platform::container::content::{ContentType, TextContent};
