...
//! # Related Modules
//!
//! - [`crate::output::citadel_port`] - State persistence (uses FileStoragePort)
//! - [`crate::output::sanctum_port`] - Vector storage (stores embeddings)
//! - [`crate::output::garrison_port`] - Conversation memory (may use file storage)
