...
- Potentially non-MIT-compatible/copyleft expressions found:
...
4. Resolve license-policy exceptions (MPL/LGPL-expression/UNKNOWN) with legal/compliance policy decisions.
