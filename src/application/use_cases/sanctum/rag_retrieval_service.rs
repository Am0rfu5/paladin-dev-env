...
impl RagRetrievalService {
    ...
    ///
    /// Creates a structured text block suitable for including in the system prompt
    /// or user message.
    ///
    /// # Arguments
    ///
...
/// Async wrapper for retrieve_context with timeout
///
/// Returns empty Vec on timeout to enable graceful degradation
