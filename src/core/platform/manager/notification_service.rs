...
use crate::core::platform::container::notification::{
    ...
    NotificationEvent, NotificationPriority, NotificationRecipient, NotificationStatus,
...
pub trait NotificationChannelHandler: Send + Sync {
    ...
    ) -> NotificationServiceResult<NotificationDeliveryResult>;
...
impl NotificationService {
    ...
    pub async fn send_notification(
        ...
        let mut notification = {
            ...
            active.remove(&notification_id).ok_or_else(|| {
                NotificationServiceError::ValidationError(format!(
        ...
        let handler = {
            ...
            handlers
                ...
                .cloned()
                .ok_or_else(|| {
                    NotificationServiceError::ChannelNotAvailable(format!(
    ...
    async fn process_template(
        ...
        let template_id = content.template_id.as_ref().ok_or_else(|| {
            NotificationServiceError::ValidationError("No template ID specified".to_string())
        })?;
        ...
        let processor = {
            ...
            processor_guard
                .as_ref()
                .ok_or_else(|| {
                    NotificationServiceError::ConfigurationError(
