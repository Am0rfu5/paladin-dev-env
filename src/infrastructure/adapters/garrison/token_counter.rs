...
///
/// ```
/// use paladin::infrastructure::adapters::garrison::token_counter::{TokenCounter, TiktokenCounter};
///
...
impl TiktokenCounter {
    ...
    /// # Errors
    ///
    /// Returns an error if the model is not supported by tiktoken
    ///
    /// # Examples
    ///
    /// ```
    /// use paladin::infrastructure::adapters::garrison::token_counter::TiktokenCounter;
    ///
    /// let counter = TiktokenCounter::new("gpt-4").unwrap();
    /// ```
...
impl TokenCounterFactory {
    ...
    ///
    /// ```
    /// use paladin::infrastructure::adapters::garrison::token_counter::{TokenCounterFactory, TokenCounter};
    ///
