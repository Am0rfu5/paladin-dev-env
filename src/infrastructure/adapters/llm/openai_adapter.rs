...
// OpenAI LLM Adapter
//
// Adapter for OpenAI GPT models implementing the LlmPort trait.
...
impl OpenAIConfig {
    ...
    /// - `OPENAI_TIMEOUT_SECONDS`: Timeout in seconds (default: 300)
    /// - `OPENAI_MAX_RETRIES`: Maximum retries (default: 3)
...
impl OpenAIAdapter {
    /// Create new OpenAI adapter with configuration
        ...
        let stream = response.bytes_stream().map(|chunk_result| {
            chunk_result
                ...
                .and_then(|chunk| {
                    ...
                    // OpenAI streams data in SSE format: "data: {...}\n\n"
