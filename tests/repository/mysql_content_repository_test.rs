...
mod tests {
    ...
    async fn test_mysql_repository_creation() {
        ...
        match MySqlContentRepository::new(config).await {
            ...
            Err(e) => {
                println!(
                    "Repository creation failed (expected in test environment): {}",
                    e
                );
    ...
    fn test_content_item_node_structure() {
        ...
        match content_item.content() {
            ContentType::Text(text) => {
                ...
                assert_eq!(
                    text.content,
                    Some("Test content for repository".to_string())
                );
    ...
    fn test_node_reconstruction_pattern() {
        ...
        let reconstructed_item = ContentItem {
        ...
        assert_eq!(
            reconstructed_item.hash(),
            Some(&"reconstructed-hash".to_string())
        );
        assert_eq!(
            reconstructed_item.description(),
            Some(&"Reconstructed description".to_string())
        );
